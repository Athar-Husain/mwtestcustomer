...
const ConnectionService = {
  ...
  getConnectionsForUser: () => axiosInstance.get('/myConnections').then((res) => res.data), // For logged-in user's connections

  getActiveConnection: () => axiosInstance.get('/activeconnection').then((res) => res.data), // For logged-in user's connections
