...
// Action to login
import { loginCustomer } from '../../redux/features/Customers/CustomerSlice';
...
const AuthLogin = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      console.error('Login failed:', err); // Error handled globally by the slice, but useful here for unwrap()
    }
  };
